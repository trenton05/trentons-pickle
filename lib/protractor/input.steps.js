...
let InputSteps = class InputSteps {
    ...
    movePosition(x, y, click) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = protractor_1.browser.actions().mouseMove({ x: Number(yield mapping_1.mapping(x)), y: Number(yield mapping_1.mapping(y)) });
            yield (click ? result.click() : result).perform();
        });
    }
    moveElement(eltMatch, click) {
        return __awaiter(this, void 0, void 0, function* () {
            const finder = browser_util_1.BrowserUtil.finder(yield mapping_1.mapping(eltMatch));
            const result = protractor_1.browser.actions().mouseMove(finder);
            yield (click ? result.click() : result).perform();
        });
    }
    hover(eltMatch) {
...
__decorate([
    cucumber_tsflow_1.when(/^I move my mouse over (.*) and down (.*?)( and click)?$/i),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Boolean]),
    __metadata("design:returntype", Promise)
], InputSteps.prototype, "movePosition", null);
__decorate([
    cucumber_tsflow_1.when(/^I move my mouse to (.*?)( and click)?$/i),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Boolean]),
    __metadata("design:returntype", Promise)
], InputSteps.prototype, "moveElement", null);
__decorate([
